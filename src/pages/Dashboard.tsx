    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="kpi-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground">{kpis.aiItemsThisWeek.toLocaleString()}</div>
            <p className="text-xs text-success mt-1">
              +23% from last week
            </p>
          </CardContent>
        ...
        <Card className="kpi-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground">{kpis.avgQuizScore}%</div>
            <p className="text-xs text-success mt-1">
              +2.1% from last month
            </p>
          </CardContent>
        ...
        <Card className="kpi-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground">{kpis.openTickets}</div>
